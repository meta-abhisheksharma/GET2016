  ...
  <table class="table">
    ...
    <%
      ...
      <tr>
        ...
        <td><a href="CarFacade?job=view&vehicle_ID=<%=vehicleVO.getVehicleVO_ID()%>">Detail View</a></td>
        <td><a href="CarFacade?job=delete&vehicle_ID=<%=vehicleVO.getVehicleVO_ID()%>">Delete Car</a></td>
        <td><a href="CarFacade?job=update&vehicle_ID=<%=vehicleVO.getVehicleVO_ID()%>">Update Car</a></td>
      </tr>
    <%
    }
    %> 
