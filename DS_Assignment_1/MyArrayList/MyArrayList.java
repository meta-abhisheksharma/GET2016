...
/**
 * This class will create and initialize an object array with dynamic size
 * size will be increased when the list is full 
 * This Class is also consist of all required operational methods on list
 */
